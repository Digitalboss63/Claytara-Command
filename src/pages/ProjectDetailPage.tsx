/**
 * ProjectDetailPage — Full project detail view
 * Sections: Overview, Infrastructure, AI Systems, Blockers, Notes
 */

import { useParams } from "wouter";
import { ArrowLeft, Globe, Github, ExternalLink, Zap, CreditCard, Users, AlertTriangle, Clock, CheckCircle2, FileText } from "lucide-react";
    ...
    <div>
      ...
      <div className="px-8 pt-8 pb-6 border-b border-border">
        ...
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <span className={cn("text-xs font-semibold uppercase tracking-wide", priorityColor(project.priority))}>
              {project.priority}
            </span>
          </div>
        </div>
      ...
      <div className="px-8 py-6 space-y-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          {/* ── Left column: Overview + Infrastructure ─────────────────────── */}
            ...
            <Card>
              ...
              <CardContent className="pt-0">
                ...
                <div className="pt-3 space-y-1.5">
                  {[
                    { label: "Agent Layer",      phase: "Phase 2" },
                    { label: "Retrieval System", phase: "Phase 2" },
                    { label: "Self-Heal",        phase: "Phase 2" },
                  ].map(({ label, phase }) => (
          ...
          <div className="space-y-4">
            ...
            {notes.length === 0 && (
              <p className="text-xs text-muted-foreground text-center py-8">
                No operational notes yet.<br />Add the first one above.
              </p>
            )}
